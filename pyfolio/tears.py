...
def create_full_tear_sheet(returns,
  ...
  charts['returns'] = create_returns_tear_sheet(
      returns,
      positions=positions,
  ...
  charts['int_times'] = create_interesting_times_tear_sheet(returns,
                                                            benchmark_rets=benchmark_rets,
                                                            set_context=set_context,
                                                            return_fig=return_fig,
                                                            show_fig=show_fig)
  ...
  if positions is not None:
    charts['position'] = create_position_tear_sheet(returns, positions,
    ...
    if transactions is not None:
      charts['txn'] = create_txn_tear_sheet(returns, positions, transactions,
                                            ...
                                            show_fig=show_fig)
      if round_trips:
        charts['round_trip'] = create_round_trip_tear_sheet(
            returns=returns,
            positions=positions,
            transactions=transactions,
            sector_mappings=sector_mappings,
      ...
      if market_data is not None:
        charts['capacity'] = create_capacity_tear_sheet(returns, positions, transactions,
  ...
  if bayesian:
    charts['bayseian'] = create_bayesian_tear_sheet(returns,
                                                    live_start_date=live_start_date,
                                                    benchmark_rets=benchmark_rets,
                                                    set_context=set_context,
                                                    return_fig=return_fig,
